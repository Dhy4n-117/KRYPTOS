...
const BruteForceEngine = {
  DICTIONARY: ['THE','KEY','SECRET','CIPHER','CODE','ALPHA','BETA','GAMMA','DELTA','OMEGA','PASS','WORD','CRYPTO','HACK','FLAG','ADMIN','LOGIN','TEST','HELLO','WORLD','PYTHON','JAVA','LINUX','KERNEL','SIGMA','THETA','ZETA','KAPPA','LAMBDA','MATRIX','SHADOW','GHOST','BLADE','STORM','FIRE','ZERO','ONE','TWO','ACE','KING','QUEEN','JACK','DARK','LIGHT','MOON','SUN','STAR','NOVA','PULSE','ROGUE','PASSWORD','SECURITY','ENCRYPT','DECRYPT','HIDDEN','OBSCURE','ENIGMA','TURING','BLETCHLEY','ULTRA','PURPLE','MERCURY','VENUS','MARS','JUPITER','SATURN','NEPTUNE','BINARY','CYBER','PHOENIX','FALCON','VIPER','COBRA','OMEGA','BRAVO','CHARLIE','FOXTROT','GOLF','HOTEL','INDIA','JULIET','KILO','LIMA','MIKE','NOVEMBER','OSCAR','PAPA','QUEBEC','ROMEO','SIERRA','TANGO','UNIFORM','VICTOR','WHISKEY','XRAY','YANKEE','ZULU'],
